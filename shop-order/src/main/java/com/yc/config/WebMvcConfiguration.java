...
public class WebMvcConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(jwtTokenInterceptor)
                ...
                .addPathPatterns("/alipay/pay")

                .excludePathPatterns("/order/admin/**")
                .excludePathPatterns("/logistics/admin/**")
                .excludePathPatterns("/graph/admin")
                .excludePathPatterns("/goodsback/admin")

                .excludePathPatterns("/alipay/notify")
                .excludePathPatterns("/order/html/**");
